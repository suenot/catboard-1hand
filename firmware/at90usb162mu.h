...
const uint8_t layer_fn[KEYS] = {
	//ROW1				ROW2			ROW3			ROW4			ROW5
	KEY_LEFT_BRACE,		KEY_QUOTE,		KEY_RCTRL,		KEY_ALT_TAB,	KEY_TURBO_REPEAT,	// COL1
	KEY_6,				KEY_P,			KEY_SEMICOLON,	KEY_N,			KEY_LAYER1,			// COL2
	KEY_7,				KEY_O,			KEY_L,			KEY_M,			NULL,				// COL3
	KEY_8,				KEY_I,			KEY_K,			KEY_COMMA,		KEY_LALT,			// COL4
	KEY_9,				KEY_U,			KEY_J,			KEY_PERIOD,		KEY_LCTRL,			// COL5
	KEY_0,				KEY_Y,			KEY_H,			KEY_SLASH,		KEY_MY_SHIFT,		// COL6
	KEY_F6,				KEY_ESC,		KEY_ENTER,		NULL,			KEY_OS_MODE,		// COL7
